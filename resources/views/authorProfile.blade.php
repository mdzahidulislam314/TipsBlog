...
@push('css')
    <link href="{{ asset('asset/frontend/css/profile/styles.css') }}" rel="stylesheet">
    <link href="{{ asset('asset/frontend/css/profile/responsive.css') }}" rel="stylesheet">
    <style>
        .favorite_posts{
            color: blue;
        }
                                ...
                                <div class="col-md-6 col-sm-12">
                                    <div class="card h-100">
                                        <div class="single-post post-style-1">
                                            ...
                                            <div class="blog-image"><img src="{{url($post->image)}}" alt=""></div>

                                            <a class="avatar" href="{{ route('author.profile',$post->user->username)
                                            }}"><img src="{{url($post->user->image)}}" alt="Profile Image"></a>
